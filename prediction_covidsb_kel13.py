# -*- coding: utf-8 -*-
"""Prediction_covidSB_kel13.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1FkGYHmqbxjnnFVjOoFOMRFk-BCybUrcS

#**Memprediksi tingkat resiko penyebaran covid berbagai kota/kabupaten di pulau sumatera dengan menggunanakan model KNN dan SVM**
...
"""Import Dataset covid-19 di pulau sumatera"""

dataset = pd.read_csv("covid_sumatera.csv")
...
#Encode untuk data kategorikal kolom kategori
...
"""###Pembagian antara data Fitur dan Label. Dari data sumbar di atas, terdapat 5 kolom fitur (data source(x)) yang terdiri dari Kab/Kota, total kasus, total kematian, masih sakit serta total sembuh dan 1 kolom label (data target(y)) yang berupa kolom Tingkat Resiko"""
...
# normalisasi = ['kota_kabupaten', 'kasus_positif_total	', 'total_meninggal', 'Tingkat Resiko']
